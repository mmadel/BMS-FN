...
@Component({
  selector: 'session-service-code-list',
  templateUrl: './session-service-code-list.component.html',
  styleUrls: ['./session-service-code-list.component.scss']
})
export class SessionServiceCodeListComponent implements OnInit {
